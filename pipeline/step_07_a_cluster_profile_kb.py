"""
step_07_a_cluster_profile_kb.py
─────────────────────────────────────────────────────────────────────────
...
def main() -> tuple[pd.DataFrame, dict]:
    ...
    print("[07_a_cluster_profile_kb] Saved:", CLUSTER_INTERPRETATION_OUT)
    print("[07_a_cluster_profile_kb] Saved:", CLUSTER_PROFILE_SUMMARY_OUT)
    print("[07_a_cluster_profile_kb] Saved:", CLUSTER_GENRE_BREAKDOWN_OUT)
    print("[07_a_cluster_profile_kb] Saved:", CLUSTER_DECADE_BREAKDOWN_OUT)
    print("[07_a_cluster_profile_kb] Saved:", CLUSTER_POP_BREAKDOWN_OUT)
